...
# Try to use proton-clang if available
...
# Robust prepend of __visible_for_testing macro for DEFEX sources using correct paths
DEFEX_COMMON_C_ABS_PATH="$KERNEL_DIR/security/samsung/defex_lsm/core/defex_common.c"
DEFEX_LSM_C_ABS_PATH="$KERNEL_DIR/security/samsung/defex_lsm/core/defex_lsm.c"
DEFEX_MAIN_C_ABS_PATH="$KERNEL_DIR/security/samsung/defex_lsm/core/defex_main.c"
DEFEX_CACHES_C_ABS_PATH="$KERNEL_DIR/security/samsung/defex_lsm/catch_engine/defex_caches.c"
DEFEX_SIGN_C_ABS_PATH="$KERNEL_DIR/security/samsung/defex_lsm/cert/defex_sign.c"
DEFEX_RULES_PROC_C_ABS_PATH="$KERNEL_DIR/security/samsung/defex_lsm/core/defex_rules_proc.c"
